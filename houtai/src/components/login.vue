...
//	import axios from 'axios'
 ...
 export default {
    ...
    methods: {
    	changeName(){
    		alert(this.$store.state.show = this.ruleForm2.name)
    	},
      submitForm(formName) {
      	var _this = this
...
//    	var _this = this
//    	axios.post('/api/regiester',{name:_this.ruleForm2.name,pass:_this.ruleForm2.pass})
//        .then(function(res){
...
//        })
      ...
      async test(){
      	const data = await login({name:'123',pass:'123'})
